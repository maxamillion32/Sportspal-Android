...
public class UserProfileDetailFragment extends Fragment implements View.OnClickListener {
    ...
    private MyTextView txt_name, txt_age, txt_information;
...
//        txt_occupation = (MyTextView) rootView.findViewById(R.id.occupation_text);
        ...
        ImageView img_fav = (ImageView) rootView.findViewById(R.id.img_favorite);
...
//        }
    ...
    private void setData() {
        ArrayList<Users> usersArrayList = ModelManager.getInstance().getUsersManager().getUserDetails(false, id);
        if (usersArrayList != null) {

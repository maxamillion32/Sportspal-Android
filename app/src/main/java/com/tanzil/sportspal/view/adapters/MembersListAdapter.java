...
public class MembersListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            String name = "";
            if (!Utils.isEmptyString(list.get(position).getLast_name()))
                name = list.get(position).getFirst_name() + " " + list.get(position).getLast_name();
            else
                name = list.get(position).getFirst_name();

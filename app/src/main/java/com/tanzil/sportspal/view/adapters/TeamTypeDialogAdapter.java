...
public class TeamTypeDialogAdapter extends BaseAdapter {
    private ArrayList<String> list;
    private Activity activity;

    public TeamTypeDialogAdapter(final Activity context,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            viewHolder.item_name.setText(list.get(position));
